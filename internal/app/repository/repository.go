	...
	components := []Component{
		{
			...
			ImageURL:         "ha_database_cluster.jpg",
		...
		},
		{
			...
			Status:           StatusPublished,
			ImageURL:         "web_server_node_alpha.jpg",
		...
		},
		{
			...
			SystemImpact:     ImpactHigh,
			Status:           StatusPublished,
			ImageURL:         "global_load_balancer.jpg",
			VideoURL:         "global_load_balancer.mp4",
			Likes:            userIDs(890),
		},
		{
			ID:               4,
			...
			SystemImpact:     ImpactHigh,
			Status:           StatusPublished,
			ImageURL:         "database_primary_replica.jpg",
			VideoURL:         "database_primary_replica.mp4",
			Likes:            userIDs(450),
		},
		{
			ID:               5,
			...
			SystemImpact:     ImpactMedium,
			Status:           StatusPublished,
			ImageURL:         "edge_caching_layer.jpg",
			VideoURL:         "edge_caching_layer.mp4",
			Likes:            userIDs(312),
		},
		{
			ID:               6,
			...
			Status:           StatusDraft,
			ImageURL:         "monitoring_probe_agent.jpg",
			VideoURL:         "monitoring_probe_agent.mp4",
			Likes:            []int{},
		},
		{
			ID:               7,
			...
			ImageURL:         "legacy_message_broker.jpg",
			VideoURL:         "legacy_message_broker.mp4",
			Likes:            userIDs(2),
		},
	}
